...
# sessions = Session.create([{title: 'Beginner Session', tutor_id: 3, student_id: 2, subject_id: 2, completed: false }])
subjects = Subject.create([{name:'Life'},{name:'Accounting'}, {name: 'C+'}, {name: 'Music'}, {name: 'Python'}, {name: 'Guitar'}])
